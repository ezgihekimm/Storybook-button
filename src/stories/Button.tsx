...
export const Button = (props: ButtonProps) => {
  ...
  switch (type) {
    case 'filled':
      if (!disabled) {
        TYPE_CLASSES =
          'text-white bg-primary-blue-500 hover:bg-primary-blue-700 focus:border-[3px] focus:border-primary-blue-100 focus:outline-0'
      }
  ...
  return (
    ...
    >
      {IconSource && iconPosition != 'none' && (
        <div className={ICON_CONTAINER_CLASSES}>
          <IconSource classNames={ICON_CLASSES} />
        </div>
      )}
